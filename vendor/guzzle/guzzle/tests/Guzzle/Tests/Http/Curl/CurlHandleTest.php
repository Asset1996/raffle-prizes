    ...
    public function dataProvider()
    {
        ...
        $tests = array(
            ...
            array('GET', 'http://www.google.com/', null, null, array(
                ...
                CURLOPT_HTTPHEADER => array('Accept:', 'Host: www.google.com', 'UserModel-Agent: ' . $userAgent),
            )),
            ...
            array('GET', 'http://127.0.0.1:8080', null, null, array(
                ...
                CURLOPT_HEADERFUNCTION => 'callback',
                CURLOPT_PORT => 8080,
                CURLOPT_HTTPHEADER => array('Accept:', 'Host: 127.0.0.1:8080', 'UserModel-Agent: ' . $userAgent),
            )),
            // Send a HEAD request
